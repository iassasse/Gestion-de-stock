...
<div class="mb-4">
    ...
    <h4 class="fw-bold mt-2 mb-1">Add Space</h4>
    <p class="text-muted mb-0">Create a new inventory storage division or pole</p>
</div>
        ...
        <div class="card premium-card p-4">
            <form method="POST" action="{{ route('espaces.store') }}">
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn gradient-btn">Create Space</button>
                </div>
            </form>
        </div>
    </div>

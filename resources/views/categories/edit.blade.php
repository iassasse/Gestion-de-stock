...
<div class="mb-4">
    ...
    <h4 class="fw-bold mt-2 mb-1">Edit Category</h4>
    <p class="text-muted mb-0">Modify the details of category #{{ $category->id }}</p>
</div>
        ...
        <div class="card premium-card p-4">
            <form method="POST" action="{{ route('categories.update', $category->id) }}">
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn gradient-btn">Update Category</button>
                </div>
            </form>
        </div>
    </div>

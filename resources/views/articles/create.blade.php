...
<div class="mb-4">
    ...
    <h4 class="fw-bold mt-2 mb-1">Add Article</h4>
    <p class="text-muted mb-0">Record a new physical item instance in inventory</p>
</div>
        ...
        <div class="card premium-card p-4">
            <form method="POST" action="{{ route('articles.store') }}">
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn gradient-btn">Create Article</button>
                </div>
            </form>
        </div>
    </div>
